        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
          ...
          >
            ...
            <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
              <button
                class="btn btn-p  rimary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top" @click="signIn"
              >
                Login
              </button>
              <button
              class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top" @click="redirectToRegister"
              >
                Register
              </button>
            </div>
